...
------------------------------------------------------ */
  ...
  $("#intro").backstretch(
    "images/1643929637_1-phonoteka-org-p-krasnii-perelivayushchiisya-fon-1.jpg"
  );
...
------------------------------------------------------ */
  ...
  $("div#counter")
    ...
    .on("update.countdown", function (event) {
      $(this).html(
        event.strftime(
          "<span>%D <em>Дни</em></span>" +
            "<span>%H <em>Часы</em></span>" +
            "<span>%M <em>Минуты</em></span>" +
            "<span>%S <em>Секунды</em></span>"
        )
      );
    });
...
------------------------------------------------------*/
  ...
  map = new GMaps({
    el: "#map",
    lat: 59.969047212154535,
    lng: 30.31499709555479,
    zoom: 15,
    zoomControl: true,
